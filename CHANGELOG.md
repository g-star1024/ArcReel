...
## [1.0.0](https://github.com/ArcReel/ArcReel/compare/v0.23.0...v1.0.0) (2026-07-27)


### ⚠ BREAKING CHANGES

* **i18n:** 移除公开的 deprecated `/api/v1/tasks/stream` SSE 端点。前端已改轮询（`frontend/src/hooks/useTasksSSE.ts` 早已切换），仓库内无生产消费者；仍在直接调用该端点的外部客户端会收到 404，请改用 `/api/v1/tasks` 轮询。
...
* **i18n:** 级联失败任务原因按界面语言正确显示，删除 deprecated /tasks/stream 端点 ([#1401](https://github.com/ArcReel/ArcReel/issues/1401)) ([c1faafa](https://github.com/ArcReel/ArcReel/commit/c1faafa29e9fe5d24a65c676234a2472dac612f3))
